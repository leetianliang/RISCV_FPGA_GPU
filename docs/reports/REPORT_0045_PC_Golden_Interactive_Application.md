...
`0911f3a74dd4c5a68895bf47430d1dae2314c5bf`
...
gpu2d_* 14/14 PASS + golden Stage-004 suite (Agent-local)
...
| SYS-07 | Stage-004 regressions still pass | PASS | model/golden/tests/ | golden_test_tile_faults, golden_test_integrity, golden_test_tile_sweep | golden_test_tile_faults |
